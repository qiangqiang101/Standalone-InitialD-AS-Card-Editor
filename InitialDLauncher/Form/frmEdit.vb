...
Public Class frmEdit
    ...
    'Translation
    Dim tool_tip, mouth_t, eyes_t, face_skin_t, accessories_t, shades_t, hair_t, shirt_t, frame_t, male, female, coming_soon, must_select_avatar, a7_none, a7_hot, a7_wind, a7_light, a7_sprit, a7_overlord, a7_fly, import_complete, error_5108_fixed, new_version As String
    ...
    Private Sub MyDiscordServerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MyDiscordServerToolStripMenuItem.Click
        Process.Start("https://discord.gg/nnJ6ghW")
    End Sub

    Private Sub ImNotMentaLOfficialWebsiteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ImNotMentaLOfficialWebsiteToolStripMenuItem.Click
        Process.Start("https://www.imnotmental.com/")
    End Sub

    Private Sub ZettabyteTechnologyOfficialWebsiteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ZettabyteTechnologyOfficialWebsiteToolStripMenuItem.Click
    ...
    Private Sub Fix5108ErrorToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles Fix5108ErrorToolStripMenuItem.Click
    ...
    Private Sub Translate()
        Select Case My.Settings.Language
            Case "English"
                Me.Text = "InitialD AS Card Editor"
                ...
                Fix5108ErrorToolStripMenuItem.Text = "Fix 5108 Error"
                AboutToolStripMenuItem.Text = "About"
                ImNotMentaLOfficialWebsiteToolStripMenuItem.Text = "I'm Not MentaL Website"
                ZettabyteTechnologyOfficialWebsiteToolStripMenuItem.Text = "Zettabyte Technology Website"
                MyDiscordServerToolStripMenuItem.Text = "My Discord Server"
                gbEditor.Title = "Editor"
            ...
            Case "Chinese"
                ...
                Fix5108ErrorToolStripMenuItem.Text = "修復5108錯誤"
                AboutToolStripMenuItem.Text = "關於"
                ImNotMentaLOfficialWebsiteToolStripMenuItem.Text = "I'm Not MentaL官方網站"
                ZettabyteTechnologyOfficialWebsiteToolStripMenuItem.Text = "Zettabyte Technology官方網站"
                MyDiscordServerToolStripMenuItem.Text = "我的Discord服務器"
                gbEditor.Title = "編輯"
            ...
            Case "French"
                ...
                Label11.Text = "Tag Pride"
                cbLegend.Text = "Unlock Legend Chapter"
                SaveToolStripMenuItem.Text = "Sauv"
                tool_tip = "Change car might lose ability to tune your car!"
...
#End Region
    ...
    Private Sub AfterCardLoaded()
        ...
        Try
            ...
            Fix5108ErrorToolStripMenuItem.Enabled = True
